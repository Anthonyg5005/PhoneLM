...
response = lm.chat(f'''
        System: The assistant gives helpful, detailed, and polite answers to the human's questions. Limited to only one interaction, resulting in no memory of any previous interations. It is currently {dateaandtime} {zone}.{daylightsavings} 
        User: {message}
        Assistant:
''')
